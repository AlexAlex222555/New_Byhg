...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоКА Тогда
		Элементы.ПартииПроизводстваЭтап.Заголовок = НСтр("ru='Партия производства';uk='Партія виробництва'");
		Элементы.ЭтапыТекущегоМесяца.Видимость = Ложь;
	Иначе
		Элементы.ЭтапыТекущегоМесяца.Заголовок = 
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Показывать только те партии, работы по которым выполнялись в текущем месяце (%1)';uk='Показувати тільки ті партії, роботи по яких виконувалися в поточному місяці (%1)'"), 
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<этапы не созданы>';uk='<етапи не створені>'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.НезаполненноеПолеТаблицы);
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<определяется при выпуске>';uk='<визначається при випуску>'"));
