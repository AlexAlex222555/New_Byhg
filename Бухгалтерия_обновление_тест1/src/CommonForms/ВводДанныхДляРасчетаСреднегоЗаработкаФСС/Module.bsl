...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.РучнаяКорректировкаСреднегоЗаработка Тогда
		Если Параметры.СреднийДневнойЗаработок = 0 И НЕ ТаблицаНачислений = Неопределено И НЕ ТаблицаВремени = Неопределено  Тогда
