...
Процедура ЗапроситьРежимИзмененияБухгалтерскогоУчета(ДатаИзменения, Отказ, ОповещениеЗавершения)
	...
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='При редактировании изменился бухгалтерский учет для организации.
                    ...
                    |;uk='При редагуванні змінився бухгалтерський облік для організації.
                    |Якщо просто виправлені попередні дані (вони були помилкові), натисніть ""Виправлена помилка"".
                    |Якщо бухоблік організації змінився з %1, натисніть ""Змінився бухоблік""'"), 
...
Процедура УстановитьДоступностьМестВыплатыЗарплаты(Форма)
	...
	КонецЕсли;
//++ ЕРП ЗИК
//~	Форма.Элементы.МестаВыплатыЗарплаты.Видимость = (Форма.МестоВыплатыЗарплатыОрганизации.Вид <> ПредопределенноеЗначение("Перечисление.ВидыМестВыплатыЗарплаты.Касса"));
//-- ЕРП ЗИК	
