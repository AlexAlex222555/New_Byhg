...
Функция ПредставлениеПериодаПоДате(ДатаНачала, Периодичность) Экспорт
	...
	Представление = "";
	КодЯзыкаДляФормат = МультиязычностьУкрПовтИсп.ОпределитьКодЯзыкаДляФормат(МультиязычностьУкрПовтИсп.КодЯзыкаИнтерфейса());
	ФорматнаяСтрокаПредставленияПериода = "ФП = Истина" + ";Л=" + КодЯзыкаДляФормат;
...
Функция ПериодЦифрамиПериодичностьПрописью(ЧислоПериодов, Периодичность) Экспорт
	...
	Если Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.День") Тогда
		ОписаниеДлительности = НСтр("ru=';%1 день;;%1 дня;%1 дней;';uk=';%1 день;;%1 дні;%1 днів;'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Неделя") Тогда
		ОписаниеДлительности = НСтр("ru=';%1 неделя;;%1 недели;%1 недель;';uk='; %1 тиждень ;; %1 тижні; %1 тижнів;'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Декада") Тогда
		ОписаниеДлительности = НСтр("ru=';%1 декада;;%1 декады;%1 декад;';uk='; %1 декада ;; %1 декади; %1 декад;'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Месяц") Тогда
		ОписаниеДлительности = НСтр("ru=';%1 месяц;;%1 месяца;%1 месяцев;';uk=';%1 місяць ;;%1 місяці;%1 місяців;'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Квартал") Тогда
		ОписаниеДлительности = НСтр("ru=';%1 квартал;;%1 квартала;%1 кварталов;';uk=';%1 квартал ;;%1 квартали;%1 кварталів;'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Полугодие") Тогда
		ОписаниеДлительности = НСтр("ru=';%1 полугодие;;%1 полугодия;%1 полугодий;';uk='; %1 півріччя ;; %1 півріччя; %1 півріч;'");
	ИначеЕсли Периодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Год") Тогда
		ОписаниеДлительности = НСтр("ru=';%1 год;;%1 года;%1 лет;';uk='; %1 рік ;; %1 роки; %1 років;'");
	КонецЕсли;
