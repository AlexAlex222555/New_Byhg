...
//-- НЕ УТ
	...
	//++ НЕ УТ
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПланПродажПоКатегориям", "НачалоПериода",      "Бюджетирование", "СценарийБюджетирования");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПланОстатков",           "НачалоПериода",      "Бюджетирование", "СценарийБюджетирования");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПланЗакупок",            "НачалоПериода",      "Бюджетирование", "СценарийБюджетирования");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПланПродаж",             "НачалоПериода",      "Бюджетирование", "СценарийБюджетирования");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПланСборкиРазборки",     "НачалоПериода",      "Бюджетирование", "СценарийБюджетирования");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПланВнутреннихПотреблений","НачалоПериода",      "Бюджетирование", "СценарийБюджетирования");

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПланПроизводства",       "НачалоПериода",      "Планирование", "Сценарий");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПланПроизводства",       "НачалоПериода",      "Бюджетирование", "СценарийБюджетирования");
	//-- НЕ УТ
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.НачислениеСписаниеРезервовПредстоящихРасходов",  "Дата", "РегламентныеОперации", "Организация");
	//-- НЕ УТ
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ОбъединениеОС",                      "Дата", "ВнеоборотныеАктивы", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.КорректировкаСтоимостиИАмортизацииОС",  "Дата", "ВнеоборотныеАктивы", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.КорректировкаСтоимостиИАмортизацииНМА", "Дата", "ВнеоборотныеАктивы", "Организация");
