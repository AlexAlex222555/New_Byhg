...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	Если НЕ ПолучитьФункциональнуюОпцию("БазоваяВерсия") Тогда
		...
		Разделы.Добавить(Метаданные.Подсистемы.ВнеоборотныеАктивы,
			НСтр("ru='Отчеты по необоротным активам';uk='Звіти за необоротними активами'"));
...
|Яка є сукупна собівартість усієї випущеної продукції за період по організаціях?'");
...
|;uk='Яка собівартість одиниці виробленої продукції? 
|Яка є сукупна собівартість усієї випущеної продукції за період по підприємству?'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Позаказный анализ удельной себестоимости выпущенной продукции по организациям.';uk='Позамовний аналіз питомої собівартості випущеної продукції по організаціях.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Позаказный анализ удельной себестоимости выпущенной продукции по предприятию.';uk='Позамовний аналіз питомої собівартості випущеної продукції по підприємству.'");
	#КонецОбласти
	...
	ОписаниеВарианта.Описание = НСтр("ru='Анализ себестоимости продукции, детализированной до первичных затрат.';uk='Аналіз собівартості продукції, деталізованої до первинних витрат.'");
...
|По яких товарах в дорозі або невідфактурованих товарах, необхідно оформити митну декларацію на імпорт?'");
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Сколько передано сырья и материалов переработчикам по заказам?';uk='Скільки передано сировини і матеріалів переробникам за замовленнями?'");
...
|;uk='Який залишок сировини і матеріалів у переробників? 
|Яка потреба в сировині і матеріалах у переробників? 
|Який надлишок / дефіцит сировини і матеріалів у переробників?'");
...
|Скільки приймань, розміщень, відборів або перерахунків було зроблено?'");
	...
	ОписаниеОтчета.Описание = НСтр("ru='Первичные затраты (материалы, труд и постатейные) отнесенные на партии производства.';uk='Первинні витрати (матеріали, праця і постатейні) віднесені на партії виробництва.'");
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
...
|;uk='Первинні витрати в розрізі організацій (матеріали, праця і постатейні), згруповані по місцях виникнення витрат. 
|Дозволяє побачити, на які партії розподілені витрати.'");
...
|;uk='Первинні витрати підрозділів в розрізі організацій (матеріали, праця і постатейні) згруповані по партіях виробництва. 
|Дозволяє побачити, з яких витрат, яких підрозділів склалася собівартість партії виробництва.'");
	УстановитьВажностьВариантаОтчета(ОписаниеВарианта, "");
	ОписаниеВарианта.ВидимостьПоУмолчанию = Истина;
...
|Позволяет увидеть, на какие партии распределены затраты.'
|;uk='Первинні витрати по підприємству в цілому (матеріали, праця і постатейні), згруповані по місцях виникнення витрат. 
|Дозволяє побачити, на які партії розподілені витрати.'");
...
|Позволяет увидеть, из каких затрат, каких подразделений сложилась себестоимость партии производства.'
|;uk='Первинні витрати підрозділів по підприємству в цілому (матеріали, праця і постатейні) згруповані по партіях виробництва. 
|Дозволяє побачити, з яких витрат, яких підрозділів склалася собівартість партії виробництва.'");
...
|;uk='Постатейні виробничі витрати в розрізі організацій, віднесені на підрозділ і розподілені на собівартість продукції. 
|Дозволяє проаналізувати, чи всі постатейні витрати розподілені на партії виробництва.'");
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОтключитьВариантОтчета(Настройки, ОписаниеОтчета, "НачальныйОстаток");
...
|Позволяет проанализировать, все ли постатейные расходы распределены на партии производства.'
|;uk='Постатейні виробничі витрати по підприємству в цілому, віднесені на підрозділ і розподілені на собівартість продукції. 
|Дозволяє проаналізувати, чи всі постатейні витрати розподілені на партії виробництва.'");
	#КонецОбласти
...
|;uk='Зведені дані про рух витрат, розподіл витрат на партії виробництва і випущеної продукції в розрізі організацій. 
|Дозволяє простежити надходження матеріалів, віднесення матеріалів, трудовитрат і постатейних витрат на партії виробництва і випуск продукції.'");
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОтключитьВариантОтчета(Настройки, ОписаниеОтчета, "НачальныйОстаток");
	ОтключитьВариантОтчета(Настройки, ОписаниеОтчета, "Поступления");
...
|Позволяет проследить поступление материалов, отнесение материалов, трудозатрат и постатейных расходов на партии производства и выпуск продукции.'
|;uk='Зведені дані про рух витрат, розподіл витрат на партії виробництва і випущеної продукції по підприємству. 
|Дозволяє простежити надходження матеріалів, віднесення матеріалів, трудовитрат і постатейних витрат на партії виробництва і випуск продукції.'");
	#КонецОбласти
	//-- НЕ УТ
...
|відхиленнями і залишком боргу за договором.'");
	...
	ОписаниеОтчета.Описание = НСтр("ru='Ведомость по резервам предстоящих расходов.';uk='Відомість по резервах майбутніх витрат.'");
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "РезервыПредстоящихРасходов");
	ОписаниеВарианта.Описание = НСтр("ru='Резервы предстоящих расходов.';uk='Резерви майбутніх витрат.'");
	#КонецОбласти
	//-- НЕ УТ
...
|Скільки він продав, списав, повернув або замовив за той же період?'");
	...
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание = НСтр("ru='Сколько сырья и материалов было передано переработчикам за период?';uk='Скільки сировини і матеріалів було передано переробникам за період?'");
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ТоварыПереданныеНаКомиссию");
...
|;uk='Скільки сировини і матеріалів було передано переробникам за період? 
|Скільки він витратив або повернув за той же період?'");
	#КонецОбласти
	//-- НЕ УТ	
...
|Скільки прийнятих на зберігання товарів необхідно викупити?'");
	...
	ОписаниеВарианта.Описание = НСтр("ru='Каковы фактические затраты по выпущенной продукции?';uk='Які фактичні витрати по випущеній продукції?'");	
	ОписаниеВарианта.ФункциональныеОпции.Добавить("ИспользоватьУправлениеПроизводством2_2");
