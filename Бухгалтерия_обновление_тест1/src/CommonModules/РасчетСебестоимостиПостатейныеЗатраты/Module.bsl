...
Процедура ПолучитьДанныеДляРаспределенияДолейПроизводственныхРасходов(ПараметрыРасчета)
	...
	Если ПараметрыРасчета.РежимОтладки Тогда	
		...
		РасходыКРаспределению        = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "РасходыКРаспределению");         
		Регистраторы                 = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "Регистраторы");                  
		РаспределитьПоПодразделениям = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "РаспределитьПоПодразделениям");  
		РаспределитьПоЭтапам         = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "РаспределитьПоЭтапам");          
		РаспределитьНаДругиеСтатьи   = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "РаспределитьНаДругиеСтатьи");    
		ОставитьВНЗП                 = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ОставитьВНЗП");                  
		...
		ДанныеПоФактическимМатериальнымЗатратам     = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ДанныеПоФактическимМатериальнымЗатратам");      
		ВТСредняяСтоимость                          = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ВТСредняяСтоимость");                           
		ДанныеПоПредварительнымМатериальнымЗатратам = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ДанныеПоПредварительнымМатериальнымЗатратам");  
		ПостоянныеПоказатели                    = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ПостоянныеПоказатели");                     
		ЗначенияПоказателей                     = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ЗначенияПоказателей");                      
		БазаПоЭтапамДетально                    = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "БазаПоЭтапамДетально");                     
		КоэффициентыПриведенияБазыРаспределения = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "КоэффициентыПриведенияБазыРаспределения");  
		БазаПоЭтапам                            = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "БазаПоЭтапам");                             
		ИтогиБазыПоЭтапамПодразделений          = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ИтогиБазыПоЭтапамПодразделений");           
		ИтогиБазыПоЭтапамВсехПодразделений      = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ИтогиБазыПоЭтапамВсехПодразделений");       
		БазаПоПодразделениямДетально               = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "БазаПоПодразделениямДетально");                
		КоэффициентыПриведенияБазыПоПодразделениям = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "КоэффициентыПриведенияБазыПоПодразделениям");  
		БазаПоПодразделениям                       = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "БазаПоПодразделениям");                        
		ИтогиБазыПоПодразделениям                  = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ИтогиБазыПоПодразделениям");                   
		ДанныеПоТрудозатратам         = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ДанныеПоТрудозатратам");          
		ОтборВидовРаботСводно         = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ОтборВидовРаботСводно");          
		ДанныеПоТрудозатратамСвернуто = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ДанныеПоТрудозатратамСвернуто");  
		ДанныеПоПродукции             = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ДанныеПоПродукции");              
		ОтборПродукцииСводно          = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ОтборПродукцииСводно");           
		ДанныеПоПродукцииСвернуто     = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ДанныеПоПродукцииСвернуто");      
		Данные = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "Данные");   
	КонецЕсли;
...
Функция ТекстОписаниеДанныхДляРаспределенияДолейПроизводственныхРасходов() Экспорт
    ...
    |	0                                                                       КАК ДоляСтоимостиНДСРегл,
	|	0                                                                       КАК ДоляСтоимостиУпр,
	|	0                                                                       КАК ДоляСтоимостиРеглБезНДС,
	|	0                                                                       КАК ДоляСтоимостиУпрБезНДС,
...
Функция ТекстДанныеПоФактическимМатериальнымЗатратам(ПараметрыРасчета = Неопределено)
	...
	ТекстЗапроса = 
        ...
        |	СУММА((ВЫБОР
        |		КОГДА ДД.НДСРегл <> 0 ИЛИ &РасчетСебестоимостиВыполнен
        |			ТОГДА ДД.НДСРегл 
        |		ИНАЧЕ ДД.Количество *
        |			(ЕСТЬNULL(Цены.НДСРегл, 0))
        |		КОНЕЦ))                                              КАК НДСРегл,
        |	СУММА((ВЫБОР
        ...
        |	СУММА((ВЫБОР
        |		КОГДА ДД.СтоимостьРеглБезНДС + ДД.ДопРасходыРеглБезНДС <> 0 ИЛИ &РасчетСебестоимостиВыполнен
        |			ТОГДА ДД.СтоимостьРеглБезНДС + ДД.ДопРасходыРеглБезНДС
        |		ИНАЧЕ ДД.Количество *
        |			(ЕСТЬNULL(Цены.СтоимостьРеглБезНДС, 0) + ЕСТЬNULL(Цены.ДопРасходыРеглБезНДС, 0))
        |		КОНЕЦ))                                              КАК СтоимостьРеглБезНДС,
        |	СУММА((ВЫБОР
        |		КОГДА ДД.СтоимостьУпрБезНДС + ДД.ДопРасходыУпрБезНДС <> 0 ИЛИ &РасчетСебестоимостиВыполнен
        |			ТОГДА ДД.СтоимостьУпрБезНДС + ДД.ДопРасходыУпрБезНДС
        |		ИНАЧЕ ДД.Количество *
        |			(ЕСТЬNULL(Цены.СтоимостьУпрБезНДС, 0) + ЕСТЬNULL(Цены.ДопРасходыУпрБезНДС, 0))
        ...
        |			ИЛИ (ДД.НДСРегл) > 0
        |			ИЛИ (ДД.СтоимостьРеглБезНДС + ДД.ДопРасходыРеглБезНДС) > 0
        |			ИЛИ (ДД.СтоимостьУпрБезНДС + ДД.ДопРасходыУпрБезНДС) > 0
...
Функция ТекстДанныеПоПредварительнымМатериальнымЗатратам()
	...
	ТекстЗапроса = 
        ...
        |	СРЕДНЕЕ(ДД.НДСРегл)                   КАК НДСРегл,
        ...
        |	, СРЕДНЕЕ(ДД.СтоимостьРеглБезНДС)     КАК СтоимостьРеглБезНДС,
        |	СРЕДНЕЕ(ДД.ДопРасходыРеглБезНДС)      КАК ДопРасходыРеглБезНДС,
        |	СРЕДНЕЕ(ДД.СтоимостьУпрБезНДС)        КАК СтоимостьУпрБезНДС,
        |	СРЕДНЕЕ(ДД.ДопРасходыУпрБезНДС)       КАК ДопРасходыУпрБезНДС
        ...
        |	СУММА(ДД.Количество *
        |		(ЕСТЬNULL(Цены.НДСРегл, 0))) КАК НДСРегл,
        |	СУММА(ДД.Количество *
        |		(ЕСТЬNULL(Цены.СтоимостьУпр, 0) + ЕСТЬNULL(Цены.ДопРасходыУпр, 0))) КАК СтоимостьУпр,
        |	СУММА(ДД.Количество *
        |		(ЕСТЬNULL(Цены.СтоимостьРеглБезНДС, 0) + ЕСТЬNULL(Цены.ДопРасходыРеглБезНДС, 0))) КАК СтоимостьРеглБезНДС,
        |	СУММА(ДД.Количество *
        |		(ЕСТЬNULL(Цены.СтоимостьУпрБезНДС, 0) + ЕСТЬNULL(Цены.ДопРасходыУпрБезНДС, 0))) КАК СтоимостьУпрБезНДС,
		|	СУММА(ДД.Количество)                КАК Количество,
		|	СУММА(&Объем * ДД.Количество)       КАК Объем,
		|	СУММА(&Вес * ДД.Количество)         КАК Вес
...
Функция ТекстБазаРаспределенияДолейПоЭтапам()
    ...
    |	, СУММА(Данные.СтоимостьРеглБезНДС)		КАК СтоимостьРеглБезНДС,
    |	СУММА(Данные.СтоимостьУпрБезНДС)		КАК СтоимостьУпрБезНДС
    ...
    // расчет выполнен следующим образом: при распределении 100 гривен цена должна содержать все знаки после запятой.
	|	ВЫБОР
    ...
    |	ВЫБОР
    |		КОГДА СУММА(ДД.НДСРегл) > 1000000000
    |	 		ТОГДА 1000000
    |		КОГДА СУММА(ДД.НДСРегл) > 100000000
    |	 		ТОГДА 100000
    |		КОГДА СУММА(ДД.НДСРегл) > 10000000
    |	 		ТОГДА 10000
    |		КОГДА СУММА(ДД.НДСРегл) > 1000000
    |	 		ТОГДА 1000
    |		КОГДА СУММА(ДД.НДСРегл) > 100000
    |	 		ТОГДА 100
    |		КОГДА СУММА(ДД.НДСРегл) > 10000
    |	 		ТОГДА 10
    |		ИНАЧЕ 1
    |	КОНЕЦ КАК КоэффициентНДСРегл,
    |	ВЫБОР
    ...
    |	, ВЫБОР
    |		КОГДА СУММА(ДД.СтоимостьРеглБезНДС) > 1000000000
    |	 		ТОГДА 1000000
    |		КОГДА СУММА(ДД.СтоимостьРеглБезНДС) > 100000000
    |	 		ТОГДА 100000
    |		КОГДА СУММА(ДД.СтоимостьРеглБезНДС) > 10000000
    |	 		ТОГДА 10000
    |		КОГДА СУММА(ДД.СтоимостьРеглБезНДС) > 1000000
    |	 		ТОГДА 1000
    |		КОГДА СУММА(ДД.СтоимостьРеглБезНДС) > 100000
    |	 		ТОГДА 100
    |		КОГДА СУММА(ДД.СтоимостьРеглБезНДС) > 10000
    |	 		ТОГДА 10
    |		ИНАЧЕ 1
    |	КОНЕЦ КАК КоэффициентРеглБезНДС,
    |	ВЫБОР
    |		КОГДА СУММА(ДД.СтоимостьУпрБезНДС) > 1000000000
    |	 		ТОГДА 1000000
    |		КОГДА СУММА(ДД.СтоимостьУпрБезНДС) > 100000000
    |	 		ТОГДА 100000
    |		КОГДА СУММА(ДД.СтоимостьУпрБезНДС) > 10000000
    |	 		ТОГДА 10000
    |		КОГДА СУММА(ДД.СтоимостьУпрБезНДС) > 1000000
    |	 		ТОГДА 1000
    |		КОГДА СУММА(ДД.СтоимостьУпрБезНДС) > 100000
    |	 		ТОГДА 100
    |		КОГДА СУММА(ДД.СтоимостьУпрБезНДС) > 10000
    |	 		ТОГДА 10
    |		ИНАЧЕ 1
    |	КОНЕЦ КАК КоэффициентУпрБезНДС
	...
	|	ВЫРАЗИТЬ(СУММА(ДД.НДСРегл) / МАКСИМУМ(КоэффициентыПриведения.КоэффициентНДСРегл) КАК ЧИСЛО (23,10)) КАК НДСРегл,
    |	ВЫРАЗИТЬ(СУММА(ДД.СтоимостьУпр) / МАКСИМУМ(КоэффициентыПриведения.КоэффициентУпр) КАК ЧИСЛО (23,10)) КАК СтоимостьУпр
    |	, ВЫРАЗИТЬ(СУММА(ДД.СтоимостьРеглБезНДС) / МАКСИМУМ(КоэффициентыПриведения.КоэффициентРеглБезНДС) КАК ЧИСЛО (23,10)) КАК СтоимостьРеглБезНДС,
    |	ВЫРАЗИТЬ(СУММА(ДД.СтоимостьУпрБезНДС) / МАКСИМУМ(КоэффициентыПриведения.КоэффициентУпрБезНДС) КАК ЧИСЛО (23,10)) КАК СтоимостьУпрБезНДС
...
Функция ТекстИтогиБазыПоЭтапам()
    ...
    |	ИЛИ СУММА(ДД.СтоимостьУпрБезНДС) > 0
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	ДД.Регистратор,
	|	ДД.Подразделение
...
Функция ТекстБазаРаспределенияДолейПоПодразделениям()
    ...
    |	СУММА(Данные.СтоимостьРегл)		КАК СтоимостьРегл,
    |	СУММА(Данные.СтоимостьРегл)		КАК НДСРегл,
    |	СУММА(Данные.Стоимость)			КАК СтоимостьУпр
    |	, СУММА(Данные.СтоимостьРегл)	КАК СтоимостьРеглБезНДС,
    |	СУММА(Данные.Стоимость)			КАК СтоимостьУпрБезНДС
	|ИЗ
	|	РаспределитьПоПодразделениям КАК ДД
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ОтборыБаз КАК Отборы
	|			ПО ДД.Регистратор = Отборы.Регистратор
    ...
    |	Данные.ДоляСтоимости 		КАК НДСРегл,
    |	Данные.ДоляСтоимости 		КАК СтоимостьУпр
    |	, Данные.ДоляСтоимости 		КАК СтоимостьРеглБезНДС,
    |	Данные.ДоляСтоимости 		КАК СтоимостьУпрБезНДС
	|ИЗ
	|	РаспределитьПоПодразделениям КАК ДД
    ...
    |	Данные.ЗначениеПоказателя	КАК НДСРегл,
    |	Данные.ЗначениеПоказателя	КАК СтоимостьУпр
    |	,Данные.ЗначениеПоказателя	КАК СтоимостьРеглБезНДС,
    |	Данные.ЗначениеПоказателя	КАК СтоимостьУпрБезНДС
	|ИЗ
	|	РаспределитьПоПодразделениям КАК ДД
    ...
    |	СУММА(ДД.НДСРегл) / МАКСИМУМ(Коэффициенты.КоэффициентНДСРегл)		    КАК НДСРегл,
    |	СУММА(ДД.СтоимостьУпр) / МАКСИМУМ(Коэффициенты.КоэффициентУпр)			КАК СтоимостьУпр
    |	,СУММА(ДД.СтоимостьРеглБезНДС) / МАКСИМУМ(Коэффициенты.КоэффициентРеглБезНДС)		КАК СтоимостьРеглБезНДС,
    |	СУММА(ДД.СтоимостьУпрБезНДС) / МАКСИМУМ(Коэффициенты.КоэффициентУпрБезНДС)			КАК СтоимостьУпрБезНДС
...
Функция ТекстНераспределяемыеДоли() // использует ОставитьВНЗП, ИтогиБазыПоЭтапамВсехПодразделений
    ...
    |		ИНАЧЕ 
    |			ВЫРАЗИТЬ(ДД.ДоляСтоимости 
    |				* ЕСТЬNULL(ИтогиБазыПоПодразделениям.НДСРегл, 
    |					ЕСТЬNULL(ИтогиБазыПоЭтапам.НДСРегл, 1)) КАК ЧИСЛО(28, 10))
    |	КОНЕЦ																	КАК ДоляСтоимостиНДСРегл,
    |	ВЫБОР 
    |		КОГДА НЕ ДД.СтатьяРасходов.ВариантРаспределенияРасходовУпр = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ИЛИ НЕ Регистраторы.УправленческийУчет
    |			ТОГДА 0
    ...
    |		ИНАЧЕ 
    |			ВЫРАЗИТЬ(ДД.ДоляСтоимости 
    |				* ЕСТЬNULL(ИтогиБазыПоПодразделениям.СтоимостьРеглБезНДС, 
    |					ЕСТЬNULL(ИтогиБазыПоЭтапам.СтоимостьРеглБезНДС, 1)) КАК ЧИСЛО(28, 10))
    |	КОНЕЦ																	КАК ДоляСтоимостиРеглБезНДС,
    |	ВЫБОР 
    |		КОГДА НЕ ДД.СтатьяРасходов.ВариантРаспределенияРасходовУпр = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ИЛИ НЕ Регистраторы.УправленческийУчет
    |			ТОГДА 0
    |		ИНАЧЕ 
    |			ВЫРАЗИТЬ(ДД.ДоляСтоимости 
    |				* ЕСТЬNULL(ИтогиБазыПоПодразделениям.СтоимостьУпрБезНДС, 
    |					ЕСТЬNULL(ИтогиБазыПоЭтапам.СтоимостьУпрБезНДС, 1)) КАК ЧИСЛО(28, 10))
    |	КОНЕЦ																	КАК ДоляСтоимостиУпрБезНДС,
...
Функция ТекстРаспределениеМеждуПартиями()
    ...
    |			ИЛИ НЕ Регистраторы.РегламентированныйУчет
    |			ТОГДА 0
    |		КОГДА ИтогиБазыПоЭтапамПодразделений.НДСРегл = 0
    |			ИЛИ ИтогиБазыПоПодразделениям.НДСРегл = 0
    |			ТОГДА 0
    |		КОГДА ПоПодразделениям.Регистратор ЕСТЬ NULL
    |			ТОГДА БазаПоЭтапам.НДСРегл
    |		ИНАЧЕ
    |			ВЫРАЗИТЬ(ЕСТЬNULL(БазаПоПодразделениям.НДСРегл, 0) 
    |				* (БазаПоЭтапам.НДСРегл 
    |				/ ИтогиБазыПоЭтапамПодразделений.НДСРегл) КАК ЧИСЛО(28, 10))
    |	КОНЕЦ КАК ДоляСтоимостиНДСРегл,
	|	ВЫБОР 
	|		КОГДА НЕ ПоПартиям.СтатьяРасходов.ВариантРаспределенияРасходовУпр = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
	|			ИЛИ НЕ Регистраторы.УправленческийУчет
	...
	|			ИЛИ НЕ Регистраторы.РегламентированныйУчет
	|			ТОГДА 0
	|		КОГДА ИтогиБазыПоЭтапамПодразделений.СтоимостьРеглБезНДС = 0
	|			ИЛИ ИтогиБазыПоПодразделениям.СтоимостьРеглБезНДС = 0
	|			ТОГДА 0
	|		КОГДА ПоПодразделениям.Регистратор ЕСТЬ NULL
	|			ТОГДА БазаПоЭтапам.СтоимостьРеглБезНДС
	|		ИНАЧЕ
	|			ВЫРАЗИТЬ(ЕСТЬNULL(БазаПоПодразделениям.СтоимостьРеглБезНДС, 0) 
	|				* (БазаПоЭтапам.СтоимостьРеглБезНДС 
	|				/ ИтогиБазыПоЭтапамПодразделений.СтоимостьРеглБезНДС) КАК ЧИСЛО(28, 10))
	|	КОНЕЦ КАК ДоляСтоимостиРеглБезНДС,
	|	ВЫБОР 
	|		КОГДА НЕ ПоПартиям.СтатьяРасходов.ВариантРаспределенияРасходовУпр = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
	|			ИЛИ НЕ Регистраторы.УправленческийУчет
	|			ТОГДА 0
	|		КОГДА ИтогиБазыПоЭтапамПодразделений.СтоимостьУпрБезНДС = 0
	|			ИЛИ ИтогиБазыПоПодразделениям.СтоимостьУпрБезНДС = 0
	|			ТОГДА 0
	|		КОГДА ПоПодразделениям.Регистратор ЕСТЬ NULL
	|			ТОГДА БазаПоЭтапам.СтоимостьУпрБезНДС
	|		ИНАЧЕ
	|			ВЫРАЗИТЬ(ЕСТЬNULL(БазаПоПодразделениям.СтоимостьУпрБезНДС, 0) 
	|				* (БазаПоЭтапам.СтоимостьУпрБезНДС
	|				/ ИтогиБазыПоЭтапамПодразделений.СтоимостьУпрБезНДС) КАК ЧИСЛО(28, 10))
	|	КОНЕЦ КАК ДоляСтоимостиУпрБезНДС,
	|	НЕОПРЕДЕЛЕНО                                                            КАК КорСтатьяРасходов,
	|	НЕОПРЕДЕЛЕНО                                                            КАК КорАналитикаРасходов,
	|	НЕОПРЕДЕЛЕНО                                                            КАК КорСтатьяАктивовПассивов,
...
Функция ТекстыОтборовБазРаспределения()
	...
	Возврат "
		...
		|	(ДД.НаправлениеРаспределения = ЗНАЧЕНИЕ(Перечисление.НаправлениеРаспределенияПоПодразделениям.ПустаяСсылка)
		|		ИЛИ НЕ ДД.НазначениеНастройкиРаспределения = ЗНАЧЕНИЕ(Перечисление.НазначениеПравилРаспределенияРасходов.РаспределениеСтатейРасходовПоЭтапамПроизводства)) КАК ПодразделенияНеОбязательны
...
Процедура ПолучитьДанныеДляПрочихРасходовНЗП(ПараметрыРасчета)
	...
	Если ПараметрыРасчета.РежимОтладки Тогда
		ДолиПроизводственныхРасходов                                = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ДолиПроизводственныхРасходов");
		втПартииДляОтнесенияРасходов                                = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "втПартииДляОтнесенияРасходов");
		ПартииДляОтнесенияРасходов                                  = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ПартииДляОтнесенияРасходов");
		ПартииДляОтнесенияРасходовСводно                            = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ПартииДляОтнесенияРасходовСводно");
		ПартииВыпущеннойПродукции                                   = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ПартииВыпущеннойПродукции");
		ВТКэшРасчетныеОборотыСебестоимостьТоваров                   = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ВТКэшРасчетныеОборотыСебестоимостьТоваров");
		МатериальныеЗатратыПроизводства                             = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "МатериальныеЗатратыПроизводства");
		ТрудозатратыПроизводства                                    = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ТрудозатратыПроизводства");
		МатериальныеИТрудозатратыПроизводства                       = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "МатериальныеИТрудозатратыПроизводства");
		ПартииМатериаловВНЗП                                        = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ПартииМатериаловВНЗП");
		ВыпущеннаяПродукция                                         = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ВыпущеннаяПродукция");
		РаботыДляДавальца                                           = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "РаботыДляДавальца");
		ЗатратыПродукции                                            = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ЗатратыПродукции");
		ВТСтоимостьПартийТоваров                                    = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ВТСтоимостьПартийТоваров");
		...
		ВТКэшРасчетныеОстаткиТрудозатратыНезавершенногоПроизводства = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ВТКэшРасчетныеОстаткиТрудозатратыНезавершенногоПроизводства");
		ВТКэшРасчетныеОборотыТрудозатратыНезавершенногоПроизводства = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ВТКэшРасчетныеОборотыТрудозатратыНезавершенногоПроизводства");
		ОстаткиБазРаспределения                                     = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "ОстаткиБазРаспределения");
		КоэффициентыПриведения                                      = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "КоэффициентыПриведения");
		Данные                                                      = ОбщегоНазначенияУТ.ПоказатьВременнуюТаблицу(ПараметрыРасчета.МенеджерВременныхТаблиц, "Данные");
	КонецЕсли;
...
Функция ТекстОписаниеДанныхДляПрочихРасходовНЗП() Экспорт
    ...
    |	ДД.УдалитьПоказательОтнесенияНаВыпускРегл								КАК ПоказательОтнесенияНаВыпускНДСРегл,
    |	ДД.УдалитьПоказательОтнесенияНаВыпускУпр								КАК ПоказательОтнесенияНаВыпускУпр,
    |	ДД.УдалитьПоказательОтнесенияНаВыпускРегл								КАК ПоказательОтнесенияНаВыпускРеглБезНДС,
    |	ДД.УдалитьПоказательОтнесенияНаВыпускУпр								КАК ПоказательОтнесенияНаВыпускУпрБезНДС,
    ...
    |	ДД.ПоказательОтнесенияНаПартиюНДСРегл									КАК ПоказательОтнесенияНаПартиюНДСРегл,
	|	ДД.ПоказательОтнесенияНаПартиюУпр										КАК ПоказательОтнесенияНаПартиюУпр,
	|	ДД.ПоказательОтнесенияНаПартиюРеглБезНДС								КАК ПоказательОтнесенияНаПартиюРеглБезНДС,
	|	ДД.ПоказательОтнесенияНаПартиюУпрБезНДС									КАК ПоказательОтнесенияНаПартиюУпрБезНДС,
	|	ЛОЖЬ 																	КАК Первичное,
	|	ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПустаяСсылка) 				КАК ХозяйственнаяОперация,
	|	ДД.РазделУчета 															КАК РазделУчета,
	|	ДД.ВидЗапасов 															КАК ВидЗапасов,
...
Функция ТекстПартииДляОтнесенияРасходов()
	...
	ТекстЗапроса =
		...
		|			И Доли.ДоляСтоимостиРеглБезНДС = 0
		|			И Доли.ДоляСтоимостиУпрБезНДС = 0
...
Функция ТекстМатериальныеЗатратыНЗП()
	...
	ТекстЗапроса =
        ...
        |	,СУММА(ДД.Количество *
        |		(ЕСТЬNULL(Цены.СтоимостьРеглБезНДС, 0)
        |		+ ЕСТЬNULL(Цены.ДопРасходыРеглБезНДС, 0)
        |		+ ЕСТЬNULL(Цены.СтоимостьЗабалансоваяРегл, 0)))       КАК СтоимостьРеглБезНДС,
        |	СУММА(ДД.Количество *
        |		(ЕСТЬNULL(Цены.СтоимостьУпрБезНДС, 0)
        |		+ ЕСТЬNULL(Цены.ДопРасходыУпрБезНДС, 0)
        |		+ ЕСТЬNULL(Цены.СтоимостьЗабалансовая, 0)))           КАК СтоимостьУпрБезНДС
...
Функция ТекстТрудозатратыНЗП()
	...
	ТекстЗапроса =
        ...
        |			ТОГДА СУММА(ДД.НормативнаяСтоимость)
        |		ИНАЧЕ СУММА(ДД.Стоимость)
        |	КОНЕЦ КАК ЧИСЛО(23,10))                                 КАК СтоимостьУпрБезНДС
...
Функция ТекстМатериальныеЗатратыИТрудозатратыНЗП()
	...
	ТекстЗапроса = 
        ...
        |	ВЫРАЗИТЬ(СУММА(ДД.НДСРегл) КАК ЧИСЛО(23,10))            КАК НДСРегл,
        |	ВЫРАЗИТЬ(СУММА(ДД.СтоимостьУпр) КАК ЧИСЛО(23,10))       КАК СтоимостьУпр
        |	,ВЫРАЗИТЬ(СУММА(ДД.СтоимостьРеглБезНДС) КАК ЧИСЛО(23,10)) КАК СтоимостьРеглБезНДС,
        |	ВЫРАЗИТЬ(СУММА(ДД.СтоимостьУпрБезНДС) КАК ЧИСЛО(23,10))   КАК СтоимостьУпрБезНДС
...
Функция ТекстПрочиеРасходыНЗПИнициализация()
	...
	ТекстЗапроса =
        ...
        |	СУММА(ДД.ПоказательОтнесенияНаВыпускНДСРегл),
        |	СУММА(ДД.ПоказательОтнесенияНаВыпускУпр)
        |	,СУММА(ДД.ПоказательОтнесенияНаВыпускРеглБезНДС),
        |	СУММА(ДД.ПоказательОтнесенияНаВыпускУпрБезНДС)
        ...
        |		СУММА(Затраты.НДСРегл) КАК ПоказательОтнесенияНаВыпускНДСРегл,
        |		СУММА(Затраты.СтоимостьУпр) КАК ПоказательОтнесенияНаВыпускУпр
        |		,СУММА(Затраты.СтоимостьРеглБезНДС) КАК ПоказательОтнесенияНаВыпускРеглБезНДС,
        |		СУММА(Затраты.СтоимостьУпрБезНДС) КАК ПоказательОтнесенияНаВыпускУпрБезНДС
		|	ИЗ
		|		ПартииДляОтнесенияРасходовСводно КАК ДД
        ...
        |		СУММА(Затраты.НДСРегл),
        |		СУММА(Затраты.СтоимостьУпр)
        |		,СУММА(Затраты.СтоимостьРеглБезНДС),
        |		СУММА(Затраты.СтоимостьУпрБезНДС)
		|	ИЗ
		|		ПартииДляОтнесенияРасходовСводно КАК ДД
		...
		|			ИЛИ ПрочиеРасходыНезавершенногоПроизводстваОстатки.СтоимостьРеглБезНДСОстаток <> 0
		|			ИЛИ ПрочиеРасходыНезавершенногоПроизводстваОстатки.НДСРеглОстаток <> 0
...
Функция ТекстКоэффициентыПриведения()
	...
	ТекстЗапроса =
        ...
        |	КОНЕЦ КАК КоэффициентРегл,
        |	ВЫБОР
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускНДСРегл) > 1000000000
        |			ТОГДА 1000000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускНДСРегл) > 100000000
        |			ТОГДА 100000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускНДСРегл) > 10000000
        |			ТОГДА 10000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускНДСРегл) > 1000000
        |			ТОГДА 1000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускНДСРегл) > 100000
        |			ТОГДА 100
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускНДСРегл) > 10000
        |			ТОГДА 10
        |		ИНАЧЕ 1
        |	КОНЕЦ КАК КоэффициентНДСРегл,
        |	ВЫБОР
        ...
        |	КОНЕЦ КАК КоэффициентУпр
        |	,ВЫБОР
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускРеглБезНДС) > 1000000000
        |			ТОГДА 1000000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускРеглБезНДС) > 100000000
        |			ТОГДА 100000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускРеглБезНДС) > 10000000
        |			ТОГДА 10000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускРеглБезНДС) > 1000000
        |			ТОГДА 1000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускРеглБезНДС) > 100000
        |			ТОГДА 100
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускРеглБезНДС) > 10000
        |			ТОГДА 10
        |		ИНАЧЕ 1
        |	КОНЕЦ КАК КоэффициентРеглБезНДС,
        |	ВЫБОР
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускУпрБезНДС) > 1000000000
        |			ТОГДА 1000000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускУпрБезНДС) > 100000000
        |			ТОГДА 100000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускУпрБезНДС) > 10000000
        |			ТОГДА 10000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускУпрБезНДС) > 1000000
        |			ТОГДА 1000
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускУпрБезНДС) > 100000
        |			ТОГДА 100
        |		КОГДА СУММА(ДД.ПоказательОтнесенияНаВыпускУпрБезНДС) > 10000
        |			ТОГДА 10
        |		ИНАЧЕ 1
        |	КОНЕЦ КАК КоэффициентУпрБезНДС
        ...
        |		ЗатратыПродукции.ПоказательОтнесенияНаВыпускНДСРегл КАК ПоказательОтнесенияНаВыпускНДСРегл,
        |		ЗатратыПродукции.ПоказательОтнесенияНаВыпускУпр КАК ПоказательОтнесенияНаВыпускУпр
        |		,ЗатратыПродукции.ПоказательОтнесенияНаВыпускРеглБезНДС КАК ПоказательОтнесенияНаВыпускРеглБезНДС,
        |		ЗатратыПродукции.ПоказательОтнесенияНаВыпускУпрБезНДС КАК ПоказательОтнесенияНаВыпускУпрБезНДС
		|	ИЗ
...
Функция ТекстОписаниеДанныхДляКоэффициентовПриведения() Экспорт
	Возврат
        ...
        |	1 КАК КоэффициентНДСРегл,
        |	1 КАК КоэффициентУпр
        |	,1 КАК КоэффициентРеглБезНДС,
        |	1 КАК КоэффициентУпрБезНДС
		|//ВоВременнуюТаблицу
		|";
КонецФункции
...
Функция ТекстОписаниеДанныхДляОстатковБазРаспределения() Экспорт
	Возврат
		...
		|	0 КАК ОстатокБезНДС,
        |	0 КАК ОстатокРегл,
        |	0 КАК ОстатокНДСРегл,
        |	0 КАК ОстатокУпр
        |	,0 КАК ОстатокРеглБезНДС,
        |	0 КАК ОстатокУпрБезНДС
		|//ВоВременнуюТаблицу
		|";
КонецФункции
...
Функция ТекстПриходыПрочихРасходовНЗП()
	Возврат "
        ...
        |	0													КАК ПоказательОтнесенияНаВыпускНДСРегл,
        |	0													КАК ПоказательОтнесенияНаВыпускУпр,
        |	0													КАК ПоказательОтнесенияНаВыпускРеглБезНДС,
        |	0													КАК ПоказательОтнесенияНаВыпускУпрБезНДС,
		...
		|	ДД.ДоляСтоимостиНДСРегл								КАК ПоказательОтнесенияНаПартиюНДСРегл,
		|	ДД.ДоляСтоимостиУпр									КАК ПоказательОтнесенияНаПартиюУпр,
		|	ДД.ДоляСтоимостиРеглБезНДС							КАК ПоказательОтнесенияНаПартиюРеглБезНДС,
		|	ДД.ДоляСтоимостиУпрБезНДС							КАК ПоказательОтнесенияНаПартиюУпрБезНДС,
...
Функция ТекстРасходыПрочихРасходовНЗППоМатериалам() // использует ПартииДляОтнесенияРасходов, МатериальныеЗатратыПроизводства, ОстаткиПриходыРасходы, РаботыДляДавальца
    ...
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовРегл = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ТОГДА ВЫРАЗИТЬ(Материальные.НДСРегл / ЕСТЬNULL(Коэффициенты.КоэффициентНДСРегл, 1) КАК ЧИСЛО (23, 10))
    |		ИНАЧЕ
    |			0
    |	КОНЕЦ КАК ПоказательОтнесенияНаВыпускНДСРегл,
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовУпр = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    ...
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовРегл = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ТОГДА ВЫРАЗИТЬ(Материальные.СтоимостьРеглБезНДС / ЕСТЬNULL(Коэффициенты.КоэффициентРеглБезНДС, 1) КАК ЧИСЛО (23, 10))
    |		ИНАЧЕ
    |			0
    |	КОНЕЦ КАК ПоказательОтнесенияНаВыпускРеглБезНДС,
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовУпр = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ТОГДА ВЫРАЗИТЬ(Материальные.СтоимостьУпрБезНДС / ЕСТЬNULL(Коэффициенты.КоэффициентУпрБезНДС, 1) КАК ЧИСЛО (23, 10))
    |		ИНАЧЕ
    |			0
    |	КОНЕЦ КАК ПоказательОтнесенияНаВыпускУпрБезНДС,
	|	0                                                   КАК ПоказательОтнесенияНаПартию,
	|	0                                                   КАК ПоказательОтнесенияНаПартиюБезНДС,
    |	0                                                   КАК ПоказательОтнесенияНаПартиюРегл,
    |	0                                                   КАК ПоказательОтнесенияНаПартиюНДСРегл,
	|	0                                                   КАК ПоказательОтнесенияНаПартиюУпр,
	|	0                                                   КАК ПоказательОтнесенияНаПартиюРеглБезНДС,
	|	0                                                   КАК ПоказательОтнесенияНаПартиюУпрБезНДС,
	|	ИСТИНА                                              КАК Первичное,
	|	НЕОПРЕДЕЛЕНО                                        КАК ХозяйственнаяОперация,
	...
	|		ИНАЧЕ
	|			ЕСТЬNULL(
    |				ВЫРАЗИТЬ(ДД.АналитикаПартииВыпуска КАК Справочник.КлючиАналитикиУчетаНоменклатуры).Назначение.НалоговоеНазначение, НЕОПРЕДЕЛЕНО)
...
Функция ТекстРасходыПрочихРасходовНЗППоТрудозатратам() // использует ПартииДляОтнесенияРасходов, ТрудозатратыПроизводства, ОстаткиПриходыРасходы, РаботыДляДавальца
    ...
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовРегл = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ТОГДА ВЫРАЗИТЬ(Трудозатраты.НДСРегл / ЕСТЬNULL(Коэффициенты.КоэффициентНДСРегл, 1) КАК ЧИСЛО (23, 10))
    |		ИНАЧЕ
    |			0
    |	КОНЕЦ КАК ПоказательОтнесенияНаВыпускНДСРегл,
    |	ВЫБОР 
    ...
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовРегл = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ТОГДА ВЫРАЗИТЬ(Трудозатраты.СтоимостьРеглБезНДС / ЕСТЬNULL(Коэффициенты.КоэффициентРеглБезНДС, 1) КАК ЧИСЛО (23, 10))
    |		ИНАЧЕ
    |			0
    |	КОНЕЦ КАК ПоказательОтнесенияНаВыпускРеглБезНДС,
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовУпр = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ТОГДА ВЫРАЗИТЬ(Трудозатраты.СтоимостьУпрБезНДС / ЕСТЬNULL(Коэффициенты.КоэффициентУпрБезНДС, 1) КАК ЧИСЛО (23, 10))
    |		ИНАЧЕ
    |			0
    |	КОНЕЦ КАК ПоказательОтнесенияНаВыпускУпрБезНДС,
	|	0                                                   КАК ПоказательОтнесенияНаПартию,
...
Функция ТекстРасходыПрочихРасходовНЗППоМатериальнымИТрудозатратам() // использует ПартииДляОтнесенияРасходов, МатериальныеИТрудозатратыПроизводства, ОстаткиПриходыРасходы, РаботыДляДавальца
    ...
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовРегл = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ТОГДА ВЫРАЗИТЬ(Затраты.НДСРегл / ЕСТЬNULL(Коэффициенты.КоэффициентНДСРегл, 1) КАК ЧИСЛО (23, 10))
    |		ИНАЧЕ
    |			0
    |	КОНЕЦ КАК ПоказательОтнесенияНаВыпускНДСРегл,
    |	ВЫБОР 
    ...
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовРегл = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ТОГДА ВЫРАЗИТЬ(Затраты.СтоимостьРеглБезНДС / ЕСТЬNULL(Коэффициенты.КоэффициентРеглБезНДС, 1) КАК ЧИСЛО (23, 10))
    |		ИНАЧЕ
    |			0
    |	КОНЕЦ КАК ПоказательОтнесенияНаВыпускРеглБезНДС,
    |	ВЫБОР 
    |		КОГДА ДД.СтатьяРасходов.ВариантРаспределенияРасходовУпр = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПроизводственныеЗатраты)
    |			ТОГДА ВЫРАЗИТЬ(Затраты.СтоимостьУпрБезНДС / ЕСТЬNULL(Коэффициенты.КоэффициентУпрБезНДС, 1) КАК ЧИСЛО (23, 10))
    |		ИНАЧЕ
    |			0
    |	КОНЕЦ КАК ПоказательОтнесенияНаВыпускУпрБезНДС,
	|	0                                                   КАК ПоказательОтнесенияНаПартию,
