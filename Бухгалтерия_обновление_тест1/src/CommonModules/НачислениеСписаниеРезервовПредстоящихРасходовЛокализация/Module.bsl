...
#Область ТекстНачислениеРезерва
	...
	ТекстЗапроса = "
	|ВЫБРАТЬ РАЗЛИЧНЫЕ //// Начисление резерва (Дт <Расходы> :: Кт 47)
	|
	...
	ТекстЗапроса = СтрШаблон(ТекстЗапроса, 
		НСтр("ru='Начисление резерва';uk='Нарахування резерву'",ЯзыкСодержания));
...
#Область ТекстВосстановлениеРезерва
	...
	ТекстЗапроса = СтрШаблон(ТекстЗапроса, 
		НСтр("ru='Восстановление резерва';uk='Відновлення резерву'",ЯзыкСодержания));
...
#Область СписаниеРасходовЗаСчетРезервов //(Дт 20 :: Кт 25, 26)
	...
	ТекстЗапроса = СтрШаблон(ТекстЗапроса, 
		НСтр("ru='Списание расходов за счет резервов';uk='Списання витрат за рахунок резервів'",ЯзыкСодержания));
