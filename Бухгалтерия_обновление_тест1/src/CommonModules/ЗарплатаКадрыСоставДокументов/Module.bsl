...
Функция СоставОбъекта(Источник, ОписаниеИсточника = Неопределено) Экспорт
	...
	Если ОписаниеИсточника = Неопределено Тогда
		...
		Если ОписаниеИсточника = Неопределено Тогда
			ВызватьИсключение НСтр("ru='Отсутствует описание объекта.';uk='Відсутній опис об''єкта.'");
		КонецЕсли;
	КонецЕсли;
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Заполняет даты документов для состава документов';uk='Заповнює дати документів для складу документів'");
