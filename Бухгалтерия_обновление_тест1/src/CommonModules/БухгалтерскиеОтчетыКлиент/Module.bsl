		...
		Если ЗначениеЗаполнено(ТекущиеДанные.Счет) Тогда
			...
			Если ИмяЭлемента = "ГруппировкаКор" Тогда 
				...
				Если ДанныеСчета.УчетПоНаправлениямДеятельности
					...
					СтрокаПредставление = СтрокаПредставление + НСтр("ru='Направление деятельности';uk='Напрям діяльності'") + ", ";
				КонецЕсли;
	...
	Иначе
		...
		Для Индекс = 1 По КоличествоСубконто Цикл
			...
			ИначеЕсли ИндексСубконто = "!" Тогда
				СписокВидовСубконто.Добавить("НаправлениеДеятельности", НСтр("ru='Направление деятельности';uk='Напрям діяльності'"), ?(Сред(СтрокаПоСубконто, Индекс * 2 - 1, 1) = "+", Истина, Ложь));
			Иначе
