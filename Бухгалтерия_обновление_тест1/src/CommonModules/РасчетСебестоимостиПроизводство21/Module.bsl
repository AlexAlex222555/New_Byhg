...
Функция ТекстТрудозатратыВыпускиБезЗаказов()
	Возврат
		...
		|	ЕСТЬNULL(РаботыДляДавальца.РазделУчета, 
		|		ВЫБОР
        ...
        |			И АналитикиУчетаПартийРабот.НалоговоеНазначение		= АналитикиУчетаПартийРаботНаРасходы.НалоговоеНазначение
...
Функция ТекстДанныеПоУказаннымТрудозатратам() // вт Данные_ПоУказаннымТрудозатратам
	Возврат
		...
		|	ДД.ЗаказНаПроизводство КАК ЗаказНаПроизводство,
        |	Выпуски.Ссылка.НалоговоеНазначение КАК НалоговоеНазначение,
        |	Выпуски.Ссылка.НалоговоеНазначение КАК НалоговоеНазначениеВыпуска,
...
Функция ТекстТекущиеРасходыМатериаловВПроизводстве()
	Возврат 
		...
		|	НЕОПРЕДЕЛЕНО КАК КорАналитикаУчетаПартий,
		|	НЕОПРЕДЕЛЕНО КАК КорАналитикаФинансовогоУчета,
		|	ДД.НалоговоеНазначениеРасходов КАК КорНалоговоеНазначение,
		|	ДД.НалоговоеНазначениеРасходов КАК НалоговоеНазначениеДокумента,
		|	0 КАК НДСУпр,
        |	0 КАК НДСРеглРеквизит,
		|	НЕОПРЕДЕЛЕНО КАК СтатьяКалькуляции,
		|	НЕОПРЕДЕЛЕНО КАК ДокументИсточник,
