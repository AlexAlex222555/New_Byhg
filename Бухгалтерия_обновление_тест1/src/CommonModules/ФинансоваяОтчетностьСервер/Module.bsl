...
// 
// Параметры:
// 	  ФормаКлиентскогоПриложения - Форма выбора поля заполнения.
//
...
// Добавляет доступные поля в строки дерева рекурсивно.
// 
// Параметры:
// 	СтрокиДерева - ДанныеФормыКоллекцияЭлементовДерева - Строки дерева.
// 	ДоступныеПоляВыбора - КоллекцияДоступныхПолейКомпоновкиДанных - доступные поля по схеме компоновки.
// 	ТекущийУровень - Число - Текущий уровень строк дерева.
// 	Форма - ФормаКлиентскогоПриложения - Форма.
// 	ЗаголовокВерхнегоУровня - Строка - Заголовок вышестоящей строки.
Процедура ДобавитьДоступныеПоляРекурсивно(СтрокиДерева, ДоступныеПоляВыбора, ТекущийУровень, Форма, ЗаголовокВерхнегоУровня)
	...
	Для каждого ДоступноеПолеВыбора Из ДоступныеПоляВыбора Цикл
		...
		Если НоваяСтрокаДерева.Значение = Форма.ТекущееВыражение Тогда
			ЭлементыДеревоВыбора = Форма.Элементы.ДеревоВыбора; // ТаблицаФормы -
			ЭлементыДеревоВыбора.ТекущаяСтрока = НоваяСтрокаДерева.ПолучитьИдентификатор();
		КонецЕсли;
