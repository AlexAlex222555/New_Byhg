...
#Область ТекстДебиторскаяЗадолженностьРасчетыСКлиентом
	...
	|	
	|	Расчеты.Предоплата + Расчеты.Долг ВалютнаяСуммаКт,
	|	0 КАК КоличествоКт,
	|	0 КАК СуммаНУКт,
	|	0 КАК СуммаПРКт,
	|	0 КАК СуммаВРКт,
	...
	ТекстДебиторскаяЗадолженностьРасчетыСКлиентом = СтрШаблон(ТекстДебиторскаяЗадолженностьРасчетыСКлиентом, 
		НСтр("ru='Списание задолженности покупателя';uk='Списання заборгованості покупця'",ЯзыкСодержания));
...
#Область ТекстДебиторскаяЗадолженностьРасчетыСКлиентомНаПрочиеАктивы
	...
	ТекстДебиторскаяЗадолженностьРасчетыСКлиентомНаПрочиеАктивы = СтрШаблон(ТекстДебиторскаяЗадолженностьРасчетыСКлиентомНаПрочиеАктивы, 
		НСтр("ru='Списание задолженности покупателя на прочие активы';uk='Списання заборгованості покупця на інші активи'",ЯзыкСодержания));
...
#Область ТекстДебиторскаяЗадолженностьРасчетыСКлиентомНаСтатьиАктивовПассивов
	...
	|ВЫБРАТЬ //// Списание задолженности покупателя на прочие активы пассивы ( :: Кт 36, 68)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	...
	ТекстДебиторскаяЗадолженностьРасчетыСКлиентомНаСтатьиАктивовПассивов = СтрШаблон(ТекстДебиторскаяЗадолженностьРасчетыСКлиентомНаСтатьиАктивовПассивов, 
		НСтр("ru='Списание задолженности покупателя на активы\пассивы';uk='Списання заборгованості покупця на активи\пасиви'",ЯзыкСодержания));
...
#Область ТекстДебиторскаяЗадолженностьРасчетыСПоставщиком
	...
	ТекстДебиторскаяЗадолженностьРасчетыСПоставщиком = СтрШаблон(ТекстДебиторскаяЗадолженностьРасчетыСПоставщиком, 
		НСтр("ru='Списание задолженности поставщика на расходы';uk='Списання заборгованості на витрати постачальника'",ЯзыкСодержания));
...
#Область ТекстДебиторскаяЗадолженностьРасчетыСПоставщикомНаПрочиеАктивы
	...
	ТекстДебиторскаяЗадолженностьРасчетыСПоставщикомНаПрочиеАктивы = СтрШаблон(ТекстДебиторскаяЗадолженностьРасчетыСПоставщикомНаПрочиеАктивы, 
		НСтр("ru='Списание задолженности поставщика на прочие активы';uk='Списання заборгованості постачальника на інші активи'",ЯзыкСодержания));
...
#Область ТекстДебиторскаяЗадолженностьРасчетыСПоставщикомНаСтатьиАктивовПассивов
	...
	|ВЫБРАТЬ //// Списание задолженности поставщика на прочие активы пассивы (Дт <Прочие счета> :: Кт 63, 37)
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	...
	ТекстДебиторскаяЗадолженностьРасчетыСПоставщикомНаСтатьиАктивовПассивов = СтрШаблон(ТекстДебиторскаяЗадолженностьРасчетыСПоставщикомНаСтатьиАктивовПассивов, 
		НСтр("ru='Списание задолженности поставщика на активы\пассивы';uk='Списання заборгованості постачальника на активи\пасиви'",ЯзыкСодержания));
...
#Область ТекстКредиторскаяЗадолженностьРасчетыСКлиентом
	...
	ТекстКредиторскаяЗадолженностьРасчетыСКлиентом = СтрШаблон(ТекстКредиторскаяЗадолженностьРасчетыСКлиентом, 
		НСтр("ru='Списание задолженности перед покупателем в доходы';uk='Списання заборгованості перед покупцем у доходи'",ЯзыкСодержания));
...
#Область ТекстКредиторскаяЗадолженностьРасчетыСКлиентомНаСтатьиАктивовПассивов
	...
	|ВЫБРАТЬ //// Списание задолженности перед покупателем в прочие активы пассивы (Дт 36, 68 :: )
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	...
	ТекстКредиторскаяЗадолженностьРасчетыСКлиентомНаСтатьиАктивовПассивов = СтрШаблон(ТекстКредиторскаяЗадолженностьРасчетыСКлиентомНаСтатьиАктивовПассивов, 
		НСтр("ru='Списание задолженности перед покупателем в активы/пассивы';uk='Списання заборгованості перед покупцем в активи/пасиви'",ЯзыкСодержания));
...
#Область ТекстКредиторскаяЗадолженностьРасчетыСПоставщиком
	...
	ТекстКредиторскаяЗадолженностьРасчетыСПоставщиком = СтрШаблон(ТекстКредиторскаяЗадолженностьРасчетыСПоставщиком, 
		НСтр("ru='Списание задолженности перед поставщиком в доходы';uk='Списання заборгованості перед постачальником у доходи'",ЯзыкСодержания));
...
#Область ТекстКредиторскаяЗадолженностьРасчетыСПоставщикомНаСтатьиАктивовПассивов
	...
	|ВЫБРАТЬ //// Списание задолженности перед поставщиком в прочие активы пассивы (Дт 63, 37 :: )
	|
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	...
	ТекстКредиторскаяЗадолженностьРасчетыСПоставщикомНаСтатьиАктивовПассивов = СтрШаблон(ТекстКредиторскаяЗадолженностьРасчетыСПоставщикомНаСтатьиАктивовПассивов, 
		НСтр("ru='Списание задолженности перед поставщиком в активы/пассивы';uk='Списання заборгованості перед постачальником на активи/пасиви'",ЯзыкСодержания));
