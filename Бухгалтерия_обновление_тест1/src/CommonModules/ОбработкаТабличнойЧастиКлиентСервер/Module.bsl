...
Процедура ПроверитьЗаполнитьСпецификацию(ТекущаяСтрока, СтруктураДействий, КэшированныеЗначения) Экспорт
	...
	Если ЗначениеЗаполнено(ТекущаяСтрока.Номенклатура) Тогда
		...
		#Иначе
			ТекстИсключения = НСтр("ru='Попытка заполнения спецификации на клиенте.';uk='Спроба заповнення специфікації на клієнті.'");
			ВызватьИсключение ТекстИсключения;
		#КонецЕсли
	Иначе
		ТекущаяСтрока[ИмяПоля] = Неопределено;
...
Процедура ЗаполнитьПолучателяПоНаправлениюВыпуска(ТекущаяСтрока, СтруктураДействий, КэшированныеЗначения) Экспорт
	...
	#Иначе
		ТекстИсключения = НСтр("ru='Попытка заполнения получателя на основании направления выпуска на клиенте.';uk='Спроба заповнення одержувача на підставі напрямку випуску на клієнті.'");
		ВызватьИсключение ТекстИсключения;
	#КонецЕсли
