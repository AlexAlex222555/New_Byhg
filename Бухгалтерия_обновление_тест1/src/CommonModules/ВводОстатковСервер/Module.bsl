...
Функция ОписаниеРазделаВводаОстатковВНА(УчитыватьФО)
	...
	ОписаниеРаздела.РазделУчета           = НСтр("ru='Необоротные активы';uk='Необоротні активи'");
	ОписаниеРаздела.ПояснениеРазделаУчета = НСтр("ru='Вводятся остатки необоротных активов';uk='Вводяться залишки необоротних активів'");
	ОписаниеРаздела.ПорядокВДереве        = 6;
...
Функция ОписаниеХозяйственныхОперацийВводаОстатковВНА(УчитыватьФО)
	...
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru='Ввод начальных остатков основных средств %1';uk='Введення початкових залишків основних засобів, %1'");
	
	//
	ОписаниеХозяйственнойОперации = ОписаниеХозяйственныхОперацийВводаОстатков.Добавить();
	ОписаниеХозяйственнойОперации.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковНМАиРасходовНаНИОКР;
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru='Ввод остатков нематериальных активов %1';uk='Введення залишків нематеріальних активів %1'");
	...
	ОписаниеХозяйственнойОперации.ДокументВводаОстатков = ИмяДокументаВводаНачальныхОстатков;
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru='Ввод начальных остатков вложений в необоротные активы %1';uk='Введення початкових залишків вкладень в необоротні активи %1'");
	
	ВводОстатковЛокализация.ДополнитьОписаниеХозяйственныхОперацийВводаОстатковВНА(УчитыватьФО, ОписаниеХозяйственныхОперацийВводаОстатков);
