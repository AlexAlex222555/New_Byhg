...
Процедура АдаптироватьЗапросСКД(СхемаКомпоновки) Экспорт
	...
	Если НаборДанных = Неопределено Тогда
		ВызватьИсключение НСтр("ru='Изменен перечень наборов данных схемы компоновки дерева себестоимости.';uk='Змінено перелік наборів даних схеми компонування дерева собівартості.'");
	Иначе
