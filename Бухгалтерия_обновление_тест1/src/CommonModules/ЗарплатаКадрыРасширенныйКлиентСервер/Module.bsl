...
Процедура УдалитьДанныеСотрудникаСписочногоДокумента(Объект, СтруктураОписания, Сотрудник) Экспорт
	...
	Для каждого ОписаниеТабличнойЧасти Из СтруктураОписания.ТабличныеЧасти Цикл
		...
		Если ОписаниеТабличнойЧасти.Ключ = "ОписаниеТабличныхЧастей"
			ИЛИ ОписаниеТабличнойЧасти.Ключ = "Сотрудники" 
	...
	Иначе
		...
		Если Лет > 0 Тогда
			...
			Если (Лет < 5 ИЛИ Лет > 20)
				...
				Иначе
					РасшифровкаЛет = НСтр("ru='года';uk='роки'");
				КонецЕсли;
...
Функция ПредставлениеСтажа(Лет, Месяцев, Дней) Экспорт 
	...
	Иначе 
		...
		Иначе
			КоличествоЛетШаблон = ?(Найти("12,13,14", ПоследниеДвеЦифры) = 0, НСтр("ru='%1  года';uk='%1  роки'"), НСтр("ru='%1 лет';uk='%1 років'"));
		КонецЕсли;
	КонецЕсли;
	...
	Иначе 
		...
		Иначе
			КоличествоМесяцевШаблон = ?(Найти("12,13,14", ПоследниеДвеЦифры) = 0, НСтр("ru='%1 месяца';uk='%1 місяці'"), НСтр("ru='%1 месяцев';uk='%1 місяців'"));
		КонецЕсли;
	КонецЕсли;
	...
	Иначе 
		...
		Иначе
			КоличествоДнейШаблон = ?(Найти("12,13,14", ПоследниеДвеЦифры) = 0, НСтр("ru='%1 дня';uk='%1 дні'"), НСтр("ru='%1 дней';uk='%1 днів'"));
		КонецЕсли;
	КонецЕсли;
