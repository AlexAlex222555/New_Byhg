...
#Область ТекстВыпускСобственнойПродукции 
	...
	// Выпуск собственной продукции (Дт 2* :: Кт 23).
	"ВЫБРАТЬ
...
#Область ТекстРаспределениеПоРасходам // (Дт Счет учета возвратных отходов :: Кт СтатьяРасходов.СчетУчета)
	...
	ТекстРаспределениеПоРасходам = СтрШаблон(ТекстРаспределениеПоРасходам, 
		НСтр("ru='Выпуск продукции по фиксированной стоимости';uk='Випуск продукції за фіксованою вартістю'",ЯзыкСодержания));
...
#Область ТекстРаспределениеПоПрочимАктивамПассивам // (Дт Счет учета возвратных отходов :: Кт Документ.СчетУчета)
	...
	ТекстРаспределениеПоПрочимАктивамПассивам = СтрШаблон(ТекстРаспределениеПоПрочимАктивамПассивам, 
		НСтр("ru='Выпуск продукции по фиксированной стоимости';uk='Випуск продукції за фіксованою вартістю'",ЯзыкСодержания));
