...
Функция ТекстЗапросаСостоянияПередачВПроизводство(ПараметрыОтбора, ТипыРаспоряжений, ТолькоНаличиеКОформлению)
	...
	|				//ПолеНоменклатура_И ЗаказыМатериаловВПроизводство.Номенклатура   = Распоряжения.Номенклатура
	|				//ПолеНоменклатура_И ЗаказыМатериаловВПроизводство.Характеристика = Распоряжения.Характеристика
	...
	|ИНДЕКСИРОВАТЬ ПО
	|	Распоряжение,
	|	//ПолеНоменклатура_Распоряжения.Номенклатура,
	|	//ПолеНоменклатура_Распоряжения.Характеристика,
	|	Склад,
	|	Получатель
	|;
	|
	...
	|			//ПолеНоменклатура_И ВтЕстьРаспоряжения.Номенклатура   = ВтЕстьНакладные.Номенклатура
	|			//ПолеНоменклатура_И ВтЕстьРаспоряжения.Характеристика = ВтЕстьНакладные.Характеристика
	|			И ВтЕстьРаспоряжения.Склад = ВтЕстьНакладные.Склад
