...
Функция ЗаменитьЕдиницуИзмеренияНаМножитель(Знач Единица)
	...
	СловоформыНедели = СтрРазделить(НСтр("ru='нед,н';uk='тиж,т'"), ",", Ложь);
	СловоформыДня = СтрРазделить(НСтр("ru='ден,дне,дня,дн,д';uk='ден,дні,дня,дн,д'"), ",", Ложь);
	СловоформыЧаса = СтрРазделить(НСтр("ru='час,ч';uk='год,г'"), ",", Ложь);
	СловоформыМинуты = СтрРазделить(НСтр("ru='мин,м';uk='хви,х'"), ",", Ложь);
	СловоформыСекунды = СтрРазделить(НСтр("ru='сек,с';uk='сек,с'"), ",", Ложь);
