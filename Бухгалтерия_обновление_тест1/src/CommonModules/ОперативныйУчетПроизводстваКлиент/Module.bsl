...
Процедура ОформитьВыработкуСотрудниковПоРаспоряжениям(СписокРаспоряжений) Экспорт
	...
	Если ПараметрыОформления = Неопределено Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='По выбранным распоряжениям выработка сотрудников уже оформлена или оформление не требуется.';uk='За вибраним розпорядженням виробіток співробітників вже оформлено або оформлення не потрібно.'"));
		Возврат;
	КонецЕсли;
	...
	Иначе
		...
		Иначе
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru='Не удалось оформить выработку по выбранным распоряжениям. Требуется перейти в форму ""К оформлению"" и создать документы вручную.';uk='Не вдалося оформити виробіток за вибраними розпорядженням. Потрібно перейти в форму ""До оформлення"" і створити документи вручну.'"));
		КонецЕсли;
