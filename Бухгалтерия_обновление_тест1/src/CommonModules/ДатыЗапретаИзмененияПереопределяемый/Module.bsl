...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Представление = НСтр("ru='Бюджетирование';uk='Бюджетування'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	...
	Раздел.Представление = НСтр("ru='Необоротные активы';uk='Необоротні активи'",МультиязычностьУкр.КодЯзыкаИнформационнойБазы());
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Организации"));
	//-- НЕ УТ
