...
Функция СреднесписочнаяЧисленностьРаботающих10ПИ(Организация, НачалоПериода, КонецПериода) Экспорт 
	...
	Возврат КадровыйУчетРасширенный.СреднесписочнаяЧисленностьРаботающих10ПИ(Организация, НачалоПериода, КонецПериода)	
...
Функция РасчетСтраховогоСтажаПоДаннымПФУ(ДатаНачалаСобытия, Организация, Сотрудник) Экспорт 
	...
	Возврат КадровыйУчетРасширенный.РасчетСтраховогоСтажаПоДаннымПФУ(ДатаНачалаСобытия, Организация, Сотрудник)	
...
//			- Страна						- СправочникСсылка.СтраныМира (Справочники.СтраныМира.Украина)
//
