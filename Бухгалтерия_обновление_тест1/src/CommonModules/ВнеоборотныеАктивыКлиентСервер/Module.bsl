...
// 
// Параметры:
// 	ЭлементФормы - Надпись - Элемент формы.
...
Функция ПараметрыПринятияКУчетуНМА(Объект, ВспомогательныеРеквизиты) Экспорт
	...
	ДоступныПараметрыАмортизацииУУ = ВспомогательныеРеквизиты.ОтражатьВУпрУчете;
	
	/////////////////////
	ДоступноОтражениеРасходовУУ = ВспомогательныеРеквизиты.ОтражатьВУпрУчете;
...
Процедура УстановитьВидимостьТекущегоЗначенияПараметраПриИзмененииПараметров(Форма, ИмяЭлемента, ИмяПараметра, ИмяТЧ, СтруктураИзмененныхРеквизитов) Экспорт
	...
	Если СтруктураИзмененныхРеквизитов.Количество() = 0 
		...
		ЭлементФормы = Форма.Элементы[?(ИмяЭлемента = Неопределено, ИмяТЧ + ИмяПараметра, ИмяЭлемента)];
		ЭлементФормы.Видимость = Форма.Объект[ИмяПараметра + "Флаг"] И Форма.ПоказатьТекущиеЗначения;
...
Функция ЗначенияСвойствЗависимыхРеквизитов_СписаниеОС(Объект, ВспомогательныеРеквизиты, ИзмененныеРеквизиты = "") Экспорт
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("ОтражатьВУпрУчете")
		ИЛИ СтруктураИзмененныхРеквизитов.Свойство("ХозяйственнаяОперация") ИЛИ ОбновитьВсе Тогда
...
Функция ЗначенияСвойствЗависимыхРеквизитов_ВводОстатков(Объект, ВспомогательныеРеквизиты, ИзмененныеРеквизиты = "") Экспорт
	...
	Если ВспомогательныеРеквизиты.ХозяйственнаяОперация = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ВводОстатковОсновныхСредств") Тогда
...
Функция ЗначенияСвойствЗависимыхРеквизитов_ВводОстатков_ОС(Объект, ВспомогательныеРеквизиты, ИзмененныеРеквизиты = "")
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("ОтражатьВРеглУчете")
		ИЛИ СтруктураИзмененныхРеквизитов.Свойство("МетодНачисленияАмортизацииНУ")
		ИЛИ СтруктураИзмененныхРеквизитов.Свойство("ДоступныПараметрыУчета")
		ИЛИ ОбновитьВсе Тогда
...
Функция ПараметрыПринятияКУчетуОСИВводаОстатков(Объект, ВспомогательныеРеквизиты)
	...
	//
	АмортизацияУУДоступна = ВспомогательныеРеквизиты.ОтражатьВУпрУчете;
