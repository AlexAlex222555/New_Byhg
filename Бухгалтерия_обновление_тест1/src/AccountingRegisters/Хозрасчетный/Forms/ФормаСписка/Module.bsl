...
Процедура НастроитьОтображениеТаблицыПроводок()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПодразделения") Тогда
		ШаблоныЗаголовка.Добавить(НСтр("ru='Подразделение %1';uk='Підрозділ %1'"));
	КонецЕсли;
	...
	Если ИспользуетсяУчетПоНаправлениям И НЕ Шапка3Этажа Тогда
		ШаблоныЗаголовка.Добавить(НСтр("ru='Направление %1';uk='Напрям %1'"));
	КонецЕсли;
	...
	Элементы.СписокСумма.Заголовок   = СтрШаблон(НСтр("ru='Сумма БУ (%1)';uk='Сума БО (%1)'"), ВалютаРУ);
	
	Элементы.СписокСуммаНУДт.Заголовок   = СтрШаблон(НСтр("ru='Сумма НУ Дт (%1)';uk='Сума ПО Дт (%1)'"), ВалютаРУ);
	Элементы.СписокСуммаНУКт.Заголовок   = СтрШаблон(НСтр("ru='Сумма НУ Кт (%1)';uk='Сума ПО Кт (%1)'"), ВалютаРУ);
	
	Элементы.СписокСуммаУУ.Заголовок = СтрШаблон(НСтр("ru='Сумма УУ (%1)';uk='Сума УО (%1)'"), ВалютаУУ);
	Элементы.СписокСуммаФО.Заголовок = СтрШаблон(НСтр("ru='Сумма ФО (%1)';uk='Сума ФЗ (%1)'"), ВалютаФО);
