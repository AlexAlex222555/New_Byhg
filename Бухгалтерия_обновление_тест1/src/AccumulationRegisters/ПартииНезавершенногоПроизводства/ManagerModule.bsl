...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Очищает измерения ""Вид запасов"" и ""Кор. вид запасов"" с типом запасов ""Услуга"" записей регистра накопления ""Партии незавершенного производства"".';uk='Очищає вимірювання ""Вигляд запасів"" та ""Кор. вид запасів"" з типом запасів ""Послуга"" записів регістру накопичення ""Партії незавершеного виробництва"".'");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	ИЛИ (ДанныеРегистра.АналитикаУчетаПродукции.Назначение <> ДанныеРегистра.КорВидЗапасов.УстарелоНазначение
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|		И Движения.АналитикаУчетаПродукции.Назначение <> Движения.КорВидЗапасов.УстарелоНазначение
	...
	|		И Движения.КорВидЗапасов.УстарелоНазначение = АналитикаПродукции.Назначение
	|
	|ГДЕ
