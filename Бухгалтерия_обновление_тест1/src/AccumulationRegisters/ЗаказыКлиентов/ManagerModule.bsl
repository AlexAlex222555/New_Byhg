...
Процедура ОписаниеОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Обновляет движения документа ""Заказ переработчику"" по регистру накопления ""Заказы клиентов"".';uk='Оновлює рухи документа ""Замовлення переробнику"" по регістру накопичення ""Замовлення клієнтів"".'");
