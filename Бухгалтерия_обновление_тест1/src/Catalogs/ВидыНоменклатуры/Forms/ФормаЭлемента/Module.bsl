...
Процедура НастроитьФорму()
	...
	Если ВТЧУказываютсяСкладыИПодразделения Тогда
		...
		ПолитикаУчетаСерийПодсказка
			= НСтр("ru='Будет использована как общая политика для всех складов и производственных подразделений: будет устанавливаться по умолчанию для новых складов и производственных подразделений.';uk='Буде використана як загальна політика для всіх складів і виробничих підрозділів: буде встановлюватися за замовчуванням для нових складів і виробничих підрозділів.'");
	ИначеЕсли ИспользоватьНесколькоСкладов Тогда
		...
		ПолитикаУчетаСерийПодсказка
			= НСтр("ru='Будет использована как общая политика для всех складов; будет устанавливаться по умолчанию для новых складов.';uk='Буде використана як загальна політика для всіх складів; буде встановлюватися за замовчуванням для нових складів.'");
	Иначе
		...
		ПолитикаУчетаСерийПодсказка
			= НСтр("ru='Будет использована как общая политика для всех производственных подразделений; будет устанавливаться по умолчанию для новых производственных подразделений.';uk='Буде використана як загальна політика для всіх виробничих підрозділів; буде встановлюватися за замовчуванням для нових виробничих підрозділів.'");
	КонецЕсли;
...
Процедура УстановитьУсловноеОформлениеРеквизитыДляКонтроля(ЗначащаяЧастьИмени)
	...
	Если ЗначащаяЧастьИмени <> "Серий" Тогда 
		...
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='<для доп. реквизитов>';uk='<для дод. реквизитів>'"));
