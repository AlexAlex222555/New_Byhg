...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Объект.НаименованиеДляПечати <> НаименованиеДляПечатиДоИзменений 
		...
		ТекстОшибки = НСтр("ru='Наименование элемента ""Редактируемое значение"" должно быть уникально';uk='Найменування елемента ""Редаговане значення"" має бути унікально'");
