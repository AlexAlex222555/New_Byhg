...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.ЭтоПростаяТаблица Тогда
		...
		ПредставлениеПоказателя = НСтр("ru='Значение ячейки';uk='Значення комірки'");
	...
	Иначе
		...
		Если НайденныеСтроки.Количество() Тогда
			ПредставлениеПоказателя = НСтр("ru='Значение (НФП)';uk='Значення (НФП)'");
		...
		Если ЕстьКоличество Тогда
			ПредставлениеПоказателя = НСтр("ru='Количество';uk='Кількість'");
			МассивПоказателей.Добавить("Количество", ПредставлениеПоказателя);
		КонецЕсли;
		
		Если ЕстьСумма Тогда
			ПредставлениеПоказателя = НСтр("ru='Сумма';uk='Сума'");
	...
	ПредставленияПараметровУО.Вставить("ЦветФона",						НСтр("ru='Цвет фона';uk='Колір фону'"));
	ПредставленияПараметровУО.Вставить("ЦветТекста",					НСтр("ru='Цвет текста';uk='Колір тексту'"));
	ПредставленияПараметровУО.Вставить("ЦветГраницы",					НСтр("ru='Цвет границы';uk='Колір межі'"));
	ПредставленияПараметровУО.Вставить("Шрифт",							НСтр("ru='Шрифт';uk='Шрифт'"));
	ПредставленияПараметровУО.Вставить("ГоризонтальноеПоложение",		НСтр("ru='Горизонтальное положение';uk='Горизонтальне положення'"));
	ПредставленияПараметровУО.Вставить("ВертикальноеПоложение",			НСтр("ru='Вертикальное положение';uk='Вертикальне положення'"));
	ПредставленияПараметровУО.Вставить("ОриентацияТекста",				НСтр("ru='Ориентация текста';uk='Орієнтація тексту'"));
	ПредставленияПараметровУО.Вставить("Формат",						НСтр("ru='Формат';uk='Формат'"));
