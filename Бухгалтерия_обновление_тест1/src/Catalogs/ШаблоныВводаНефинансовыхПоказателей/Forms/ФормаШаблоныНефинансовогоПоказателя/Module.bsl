...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.Свойство("Показатель") Тогда
		ТекстСообщения = НСтр("ru='Непосредственное открытие этой формы не предусмотрено. Для открытия формы можно воспользоваться командой ""Шаблоны ввода"" в форме нефинансовых показателей.';uk='Безпосереднє відкриття цієї форми не передбачено. Для відкриття форми можна скористатися командою ""Шаблони введення"" в формі нефінансових показників.'");
