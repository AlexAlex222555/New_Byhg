...
Процедура НастроитьЭлементыФормы()
    ...
    ВидимостьТипУпрСуммы = Ложь;
	Если ПравилоПоОперативномуУчету Тогда
    	ВидимостьТипУпрСуммы = ИсточникиДанныхПовтИсп.ИсточникДопускаетВыборТипаУпрСуммы(Объект.ИсточникДанных);
	КонецЕсли;
	Элементы.ТипУпрСуммы.Видимость = ВидимостьТипУпрСуммы;
