...
Процедура НастроитьФормуЛокализация()
	...
	//++ НЕ УТ
	Элементы.ГруппаПодразделение.РасширеннаяПодсказка.Заголовок = НСтр("ru='Используется в бухгалтерских проводках по номенклатуре и при синхронизации данных о товародвижении.';uk='Використовується в бухгалтерських проводках по номенклатурі і при синхронізації даних про рух товару.'");
	//-- НЕ УТ
