	...
	Если Не ЭтоГруппа Тогда
		...
		Если ЗначениеЗаполнено(КонецДействия) Тогда
			Если КонецДействия <= НачалоДействия Тогда
				ТекстОшибки = НСтр("ru='Дата окончания действия модели не может быть меньше даты начала действия';uk='Дата закінчення дії моделі не може бути менша дати початку дії'");
