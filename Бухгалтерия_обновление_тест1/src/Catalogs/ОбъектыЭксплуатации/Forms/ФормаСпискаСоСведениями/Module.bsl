...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользоватьУчет2_4 Тогда
		...
		Если НЕ ВедетсяРегламентированныйУчетВНА Тогда
			Элементы.СписокСостояниеУпр.Заголовок = НСтр("ru='Состояние';uk='Стан'");
			...
			Элементы.СписокДатаПринятияКУчетуУпр.Заголовок = НСтр("ru='Принято к учету';uk='Прийнято до обліку'");
		...
		Заголовок = НСтр("ru='Основные средства';uk='Основні засоби'");
	...
	Иначе
		Элементы.СписокСостояниеРегл.Заголовок = НСтр("ru='Состояние';uk='Стан'");
		Элементы.СписокСостояниеУпр.Видимость = Ложь;
		Элементы.СписокДатаПринятияКУчетуРегл.Заголовок = НСтр("ru='Принято к учету';uk='Прийнято до обліку'");
		Элементы.СписокДатаПринятияКУчетуУпр.Видимость = Ложь;
		Заголовок = НСтр("ru='ОС и объекты строительства';uk='ОЗ та об''єкти будівництва'");
	КонецЕсли;
