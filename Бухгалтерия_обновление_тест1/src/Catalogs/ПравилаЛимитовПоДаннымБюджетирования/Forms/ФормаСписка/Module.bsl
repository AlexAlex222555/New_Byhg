...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ВладелецОпределен Тогда
		ВызватьИсключение НСтр("ru='Просмотреть список лимитов можно только в форме модели бюджетирования';uk='Переглянути список лімітів можна тільки в формі моделі бюджетування'");
	КонецЕсли;
