...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПредупреждениеОНевозможностиСозданияПозицийКартинка = БиблиотекаКартинок.ИнформацияБСП;
		...
		Если ЗначениеЗаполнено(ДокументУтверждения.Ссылка) Тогда
			...
			Если ЗначениеЗаполнено(ОтборПодразделение)
				...
				ПредупреждениеОНевозможностиСозданияПозицийТекст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Подразделение ""%1"" еще  не включено в штатное расписание. Откройте документ, утвердивший штатное расписание на %2 года и дозаполните его, или внесите изменение в штатное расписание с текущего месяца.';uk='Підрозділ ""%1"" ще не включено в штатний розклад. Відкрийте документ, яким затверджено штатний розклад на %2 року і дозаповніть його, або внесіть зміни в штатний розклад з поточного місяця.'"),
					ОтборПодразделение,
			...
			Иначе
				...
				ПредупреждениеОНевозможностиСозданияПозицийТекст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Если необходимая позиция штатного расписания еще не утверждена, откройте документ, утвердивший штатное расписание на %1 года и дозаполните его, или внесите изменение в штатное расписание с текущего месяца.';uk='Якщо необхідна позиція штатного розкладу ще не затверджена, відкрийте документ, яким затверджено штатний розклад на %1 року і дозаповніть його, або внесіть зміни в штатний розклад з поточного місяця.'"),
					Формат(ДокументУтверждения.ДатаУтверждения, "ДФ='д МММ гггг'"));
