...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользоватьУчет2_4 Тогда
		...
		Если НЕ ВедетсяРегламентированныйУчетВНА Тогда
			...
			Элементы.СписокДатаПринятияКУчетуУпр.Заголовок = НСтр("ru='Принят к учету';uk='Прийнятий до обліку'");
	...
	Иначе
		...
		Элементы.СписокДатаПринятияКУчетуРегл.Заголовок = НСтр("ru='Принят к учету';uk='Прийнятий до обліку'");
...
Процедура ЗаполнитьСведения(Форма)
	...
	Элементы.ГруппаСведения.Заголовок = НСтр("ru='Сведения о нематериальном активе';uk='Відомості про нематеріальний актив'");
