...
Процедура УстановитьВидимостьСтраницФормыИДоступностьЭлементов(РежимРедактирования, ЗаполнятьПоДефициту)
	...
	ИначеЕсли ТипПлана = Перечисления.ТипыПланов.ПланПроизводства Тогда
		...
		Вариант.Представление = НСтр("ru='по производимой продукции';uk='За виробленою продукцією'");
		Вариант.Описание = НСтр("ru='Позволяет заполнить номенклатуру, которая когда-либо производилась.';uk='Дозволяє заповнити номенклатуру, яка коли-небудь вироблялась.'");
		ВариантыЗаполненияСостава.Добавить(Вариант);
