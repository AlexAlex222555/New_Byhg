		 ...
		 ИЛИ Ссылка = Справочники.Сценарии.ИсполнениеБюджета Тогда
			Если Родитель <> Ссылка.Родитель Тогда
				...
				Исключение
					...
					ИмяСобытия = НСтр("ru='Запись сценария';uk='Запис сценарію'",КодЯзыка);
					ТекстСообщенияЖР = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='Не удалось очистить кэш вспомогательных данных по причине: %1';uk='Не вдалося очистити кеш допоміжних даних з прични: %1'",КодЯзыка),
						ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
					ТекстСообщения   = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='Не удалось очистить кэш вспомогательных данных по причине: %1';uk='Не вдалося очистити кеш допоміжних даних з прични: %1'"),
						ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
