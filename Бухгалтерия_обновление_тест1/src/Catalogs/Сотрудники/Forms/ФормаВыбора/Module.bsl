...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("РольСотрудника", РольСотрудника)
		...
		Если РольСотрудника = Перечисления.РолиСотрудников.Работник Тогда
			...
			ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
				Список, "Работник", Истина, ВидСравненияКомпоновкиДанных.Равно,НСтр("ru='Работник';uk='Працівник'"));
	...
	Если ЗначениеЗаполнено(Подразделение)
		...
		Иначе
			РеквизитыОбъектов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Подразделение, "Владелец");
			Организация = РеквизитыОбъектов.Владелец;
	...
	Если ЗначениеЗаполнено(Организация) Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			Список, "Организация", ОрганизацииОтбора, ВидСравненияПоляОрганизация,НСтр("ru='Организация';uk='Організація'"));
	...
	Если ЗначениеЗаполнено(Филиал) Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			Список, "Филиал", ФилиалОтбора, ВидСравненияПоляОрганизация,НСтр("ru='Филиал';uk='Філія'"));
	...
	Если ТрудовыеОтношенияОформлены <> Неопределено Тогда
		...
		Если ПараметрыОтбораПоПериоду.ОтборПоПериодуКадровыхДанныхИспользуется
			...
			ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
				...
				ВидСравненияКомпоновкиДанных.Равно,НСтр("ru='Трудовые отношения оформлены';uk='Трудові відносини оформлені'") , Истина, РежимОтображенияТрудовыеОтношенияОформлены);
...
Процедура ИнициализироватьЭлементОтбора(ЭлементОтбора, ПараметрОтбора)
	...
	Иначе
		...
		Если ТипЗнч(ЭлементОтбора.ПравоеЗначение) = Тип("Булево") Тогда
			...
			ЭлементОтбора.ПредставлениеПользовательскойНастройки = ?(Не ЗначениеЗаполнено(ЗарплатаКадрыКлиентСервер.ПредставлениеЭлементаОтбораДинамическогоСписка(ЭтаФорма, ПараметрОтбора.Ключ)),ПараметрОтбора.Ключ,ЗарплатаКадрыКлиентСервер.ПредставлениеЭлементаОтбораДинамическогоСписка(ЭтаФорма, ПараметрОтбора.Ключ));
