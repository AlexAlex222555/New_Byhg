...
Процедура СформироватьЗаголовкиПоясняющихНадписей()
	...
	ИначеЕсли Объект.ТипОбеспечения = Перечисления.ТипыОбеспечения.Перемещение Тогда
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеПроизводством2_2") Тогда
			ПояснениеТипаОбеспечения = НСтр("ru='Данный способ обеспечения позволяет формировать заказы на перемещение и заказы материалов в цеховые кладовые.';uk='Даний спосіб забезпечення дозволяє формувати замовлення на переміщення і замовлення матеріалів в цехові комори.'");
		КонецЕсли;
		//-- НЕ УТ
...
Функция ТекстОшибкиГарантированногоСрокаОтгрузки()
	...
	//++ НЕ УТ
	ИначеЕсли Объект.ТипОбеспечения = ПредопределенноеЗначение("Перечисление.ТипыОбеспечения.Производство") Тогда
		Пояснение = НСтр("ru='Гарантированный срок отгрузки не может быть меньше срока производства. Гарантированный срок отгрузки увеличен.';uk='Гарантований термін відвантаження не може бути менше терміну виробництва. Гарантований термін відвантаження збільшений.'");
	ИначеЕсли Объект.ТипОбеспечения = ПредопределенноеЗначение("Перечисление.ТипыОбеспечения.ПроизводствоНаСтороне") Тогда
